...
export default function GWFilterPage({ matches, nextGW, upcomingGWs, grouped }: {
  matches: any[]
  nextGW: number
  upcomingGWs: number[]
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .gw-pill { flex-shrink: 0; padding: 6px 14px; border-radius: 20px; font-size: 12px; font-weight: 600; letter-spacing: 0.5px; cursor: pointer; border: 1px solid #1a2030; background: #0e1318; color: #4a5568; transition: all 0.2s; }
        ...
        .vs-block { display: flex; align-items: center; flex-shrink: 0; }
        .score { font-family: 'Bebas Neue', sans-serif; font-size: 24px; color: #ffffff; letter-spacing: 1px; min-width: 20px; text-align: center; }
      ...
      <div className="app">
        ...
        <div className="content">
          {gwMatches.map((match: any) => {
            ...
            return (
              <a key={match.fixture_id} href={`/match/${match.fixture_id}`} className="match-card">
