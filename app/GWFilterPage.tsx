...
export default function GWFilterPage({ matches, nextGW, upcomingGWs, grouped, isPro }: Props) {
  const [selectedGW, setSelectedGW] = useState(nextGW)
  const [showPopup, setShowPopup] = useState(!isPro)
  ...
  return (
    <>
      ...
      <div className="app">
        {showPopup && <ProTrialPopup onClose={() => setShowPopup(false)} />}
